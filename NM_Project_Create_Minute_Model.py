...
train_dataset = tf.data.Dataset.from_tensor_slices((input_train_minute, output_train_minute_OHE))
test_dataset = tf.data.Dataset.from_tensor_slices((input_test_minute, output_test_minute_OHE))
...
model.save('NM_Project_Minute_OHE.h5')